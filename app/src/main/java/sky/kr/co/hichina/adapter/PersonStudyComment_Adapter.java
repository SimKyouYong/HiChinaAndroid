...
public class PersonStudyComment_Adapter extends BaseAdapter {
	...
	public PersonStudyComment_Adapter(Activity a, ArrayList<PersonStudyObj> m_board, Handler mAfterAccum_) {
		activity = a;
