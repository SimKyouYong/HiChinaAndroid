...
public class ChinaLifeDetailActivity extends ActivityEx {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chinalifedetail);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.comment_btn:
                    ...
                    map.clear();
                    map.put("url", DEFINE.SERVER_URL + "CHINALIFE_COMMENT_WRITE.php");
                    ...
                    mThread = new AccumThread(ChinaLifeDetailActivity.this , mAfterAccum , map , 0 , 1 , null);
                    mThread.start();
                ...
                case R.id.top_right_btn:
                    ...
                    map.put("SELF_ID_KEY_INDEX",Check_Preferences.getAppPreferences(getApplicationContext() ,"KEY_INDEX"));
                    mThread = new AccumThread(ChinaLifeDetailActivity.this , mAfterAccum , map , 0 , 3 , null);
                    mThread.start();
                    break;
    ...
    private void postCommetSelAPI(){
        customProgressPop();
        arr = new ArrayList<SchoolInfoObj>();
        map.put("url", DEFINE.SERVER_URL + "CHINALIFE_COMMENT_SELECT.php");
    ...
    Handler mAfterAccum = new Handler()
    {
        ...
        public void handleMessage(Message msg)
        {
            ...
            if (msg.arg1  == 0 ) {
                ...
                m_Adapter = new SchoolInfoComment_Adapter(ChinaLifeDetailActivity.this ,arr, mAfterAccum);
    ...
    private void postSelAPI(){
        ...
        arr = new ArrayList<SchoolInfoObj>();
        map.clear();
        map.put("url", DEFINE.SERVER_URL + "CHINALIFE_SELECT_IN.php");
        map.put("KEY_INDEX", ""+obj.getKEY_INDEX());
