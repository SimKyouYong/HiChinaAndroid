...
public class ChinaLifeObj implements Parcelable{
	public static Creator<ChinaLifeObj> getCreator() {
		return CREATOR;
	}
    ...
    int COUNT;
    public ChinaLifeObj(String KEY_INDEX,
                        String PARENT_KEYINDEX,
                        String BODY,
                        String SELF_ID,
                        String GOOD_EA,
	...
	public static final Creator<ChinaLifeObj> CREATOR = new Creator() {
		public Object createFromParcel(Parcel in) {
			return new ChinaLifeObj(in);
		}

		public Object[] newArray(int size) {
			return new ChinaLifeObj[size];
		}
	};
