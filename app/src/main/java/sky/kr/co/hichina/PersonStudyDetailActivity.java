...
public class PersonStudyDetailActivity extends ActivityEx {
    ...
    private void postCommetSelAPI(){
        ...
        map.clear();
        map.put("url", DEFINE.SERVER_URL + "POERSON_STUDY_COMMENT_SELECT.php");
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.comment_btn:
                    ...
                    arr = new ArrayList<PersonStudyObj>();
                    map.clear();
                    map.put("url", DEFINE.SERVER_URL + "POERSON_STUDY_COMMENT_WRITE.php");
                    ...
                    mThread = new AccumThread(PersonStudyDetailActivity.this , mAfterAccum , map , 0 , 1 , null);
                    mThread.start();
                ...
                case R.id.top_right_btn:
                    ...
                    customProgressPop();
                    map.clear();
                    map.put("url", DEFINE.SERVER_URL + "POERSON_STUDY_GOOD.php");
                    String Flag = "";
                    ...
                    map.put("SELF_ID_KEY_INDEX",Check_Preferences.getAppPreferences(getApplicationContext() ,"KEY_INDEX"));
                    mThread = new AccumThread(PersonStudyDetailActivity.this , mAfterAccum , map , 0 , 3 , null);
                    mThread.start();
                    break;
    ...
    Handler mAfterAccum = new Handler()
    {
        ...
        public void handleMessage(Message msg)
        {
            ...
            if (msg.arg1  == 0 ) {
                ...
                m_Adapter = new PersonStudyComment_Adapter(PersonStudyDetailActivity.this ,arr, mAfterAccum);
    ...
    private void postSelAPI(){
        ...
        arr = new ArrayList<PersonStudyObj>();
        map.clear();
        map.put("url", DEFINE.SERVER_URL + "POERSON_STUDY_SELECT_IN.php");
        map.put("KEY_INDEX", ""+obj.getKEY_INDEX());
