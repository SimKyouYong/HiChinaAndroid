...
public class ChinaLife_Adapter extends BaseAdapter {
	...
	public ChinaLife_Adapter(Activity a, ArrayList<ChinaLifeObj> m_board, Handler mAfterAccum_) {
		activity = a;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.activity_chinalife_item,null);
