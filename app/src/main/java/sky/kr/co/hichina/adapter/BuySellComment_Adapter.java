...
public class BuySellComment_Adapter extends BaseAdapter {
	...
	public BuySellComment_Adapter(Activity a, ArrayList<BuySellObj> m_board, Handler mAfterAccum_) {
		activity = a;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.activity_buysellcomment_item,null);
